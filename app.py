...
@app.post("/api/search-talent-pool")
async def search_talent_pool_endpoint(
    ...
    try:
        from agent import run_talent_search_agent
...
@app.api_route("/api/optimize-resume", methods=["POST", "OPTIONS"])
@app.api_route("/api/optimize-resume/", methods=["POST", "OPTIONS"])
async def optimize_resume_endpoint(
    ...
    try:
        from agent import run_ats_optimizer_agent
